import p1 from "../../img/person_5.jpg"
import p2 from "../../img/person_6.jpg"
import p3 from "../../img/person_7.jpg"
import p4 from "../../img/person_8.jpg"
function Section4(){
  ...
  <div className="container">
    ...
    <div className="row">
      <div className="col-lg-3 col-md-6 d-flex mb-sm-4 ">
        <div className="staff">
          <div className="img mb-4" style={{backgroundImage: "url(" + p1 + ")"}} />
      ...
      <div className="col-lg-3 col-md-6 d-flex mb-sm-4 ">
        <div className="staff">
          <div className="img mb-4" style={{backgroundImage: "url(" + p2 + ")"}} />
          <div className="info text-center">
      ...
      <div className="col-lg-3 col-md-6 d-flex mb-sm-4 ">
        <div className="staff">
          <div className="img mb-4" style={{backgroundImage: "url(" + p3 + ")"}} />
          <div className="info text-center">
      ...
      <div className="col-lg-3 col-md-6 d-flex mb-sm-4 ">
        <div className="staff">
          <div className="img mb-4" style={{backgroundImage: "url(" + p4 + ")"}} />
          <div className="info text-center">
