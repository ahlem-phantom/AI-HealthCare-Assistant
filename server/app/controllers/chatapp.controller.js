    ...
    if(response.intent.displayName === "Take_appointment_phase1"){
      ...
      if(doc !== null ){
          ...
          resolve(test)
            ...
            ChatTalks.create({messageSent ,messageReceived , date , user  });
            var mailOptions = {
              from: 'skander.turki@esprit.tn',
              to: Email,
              subject: 'Appointment confirmed',
              text: 'You have an appointment with '+ docname + ' ' + doclastname + ' in ' + StartDate + ', if you want to cancel the appointment call this number :'+ docphone
            };
